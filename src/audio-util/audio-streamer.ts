...
export class AudioStreamer {
  ...
  constructor(public context: AudioContext) {
    ...
    // this.destination = this.context.destination; // to play directly on speakers
    let mediaStreamDestinationNode = this.context.createMediaStreamDestination();
    this.outputStream = mediaStreamDestinationNode.stream;
    this.destination = mediaStreamDestinationNode;
